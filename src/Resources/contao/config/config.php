...
$GLOBALS['TL_MODELS']['tl_points_of_interest'] = Oneup\Contao\Poi\Model\PointsOfInterestModel::class;
$GLOBALS['TL_MODELS']['tl_point_of_interest'] = Oneup\Contao\Poi\Model\PointOfInterestModel::class;
